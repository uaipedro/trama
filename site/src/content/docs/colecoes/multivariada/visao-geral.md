...
- Logística: [Regressão](/trama/colecoes/multivariada/logistic/), [Razões de chances](/trama/colecoes/multivariada/logistic-coefficients/), [Gráfico das razões](/trama/colecoes/multivariada/plot-odds/), [Curva ROC](/trama/colecoes/multivariada/roc/), [Curva precisão-revocação](/trama/colecoes/multivariada/pr-curve/), [Jackknife](/trama/colecoes/multivariada/jackknife-logistic/)
