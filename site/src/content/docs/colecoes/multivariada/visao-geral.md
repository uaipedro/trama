...
- Logística: [Regressão](/trama/colecoes/multivariada/logistic/), [Coeficientes](/trama/colecoes/modelos/coefficients/) (modelos), [Gráfico dos coeficientes](/trama/colecoes/modelos/plot-coefficients/) (modelos), [Curva ROC](/trama/colecoes/modelos/roc/) (modelos), [Curva precisão-revocação](/trama/colecoes/modelos/pr-curve/) (modelos), [Jackknife](/trama/colecoes/multivariada/jackknife-logistic/)
- Agrupamento: [Matriz de distância](/trama/colecoes/multivariada/distance/), [Agrupamento](/trama/colecoes/multivariada/cluster/), [Dendrograma](/trama/colecoes/multivariada/plot-dendrogram/), [Tocher](/trama/colecoes/multivariada/tocher/)
- MANOVA: [MANOVA](/trama/colecoes/multivariada/manova/)
