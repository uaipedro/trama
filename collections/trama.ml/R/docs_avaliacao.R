  ...
  list(
    ...
    "ml/roc" = list(
      pressupostos = list(teste_fora,
        ...
        P("O **intervalo de DeLong** é assintótico (normal): com poucos positivos ou negativos, ou AUC perto de 1, ele fica estreito demais e é truncado em [0, 1]. Com AUC = 0 ou 1 a variância de DeLong é zero: o intervalo sai **indisponível** (NA), com a nota em `auc_nota`, em vez de um falso intervalo de largura zero. Com menos de duas linhas numa das classes a variância não existe e o IC também sai NA, com a nota; a curva e a AUC continuam.",
