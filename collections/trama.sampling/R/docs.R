...
.tr_sampling_refs <- function() {
  ...
  list(
    ...
    horvitz = R(autores = c("Horvitz, D. G.", "Thompson, D. J."), ano = 1952,
                ...
                fonte = "Journal of the American Statistical Association, 47(260)",
    ...
    woodruff = R(autores = "Woodruff, R. S.", ano = 1971,
                 ...
                 fonte = "Journal of the American Statistical Association, 66(334)",
    ...
    deville = R(autores = c("Deville, J.-C.", "Särndal, C.-E."), ano = 1992,
                ...
                fonte = "Journal of the American Statistical Association, 87(418)",
    ...
    neyman = R(autores = "Neyman, J.", ano = 1934,
               ...
               fonte = "Journal of the Royal Statistical Society, 97(4)", doi = "10.2307/2342192",
               papel = "teoria"),
    thompson = R(autores = "Thompson, S. K.", ano = 1987, titulo = "Sample Size for Estimating Multinomial Proportions",
                 fonte = "The American Statistician, 41(1)", doi = "10.1080/00031305.1987.10475440",
                 papel = "teoria"),
