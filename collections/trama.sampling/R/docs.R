...
.tr_sampling_refs <- function() {
  ...
  list(
    ...
    korn98 = R(autores = c("Korn, E. L.", "Graubard, B. I."), ano = 1998,
               titulo = "Confidence Intervals for Proportions with Small Expected Number of Positive Counts Estimated from Survey Data",
               fonte = "Survey Methodology, 24(2), 193-201 (Statistics Canada, 12-001-X199800204356; sem DOI)",
               papel = "teoria"),
