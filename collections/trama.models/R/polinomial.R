...
#' @param confianca nível de confiança; o grau da equação é o maior
#'   significativo a alfa = 1 - confianca.
#' @return objeto `tr_models_effects`, com `coeficientes`, `grau_equacao` e `r2`.
#' @export
tr_models_polinomial <- function(modelo, tratamento = "", grau = 3L, confianca = 0.95) {
  ...
  # Glossário: o nível é `confianca`; a conta segue com alfa = 1 - confiança.
