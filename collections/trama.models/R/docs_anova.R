...
.tr_models_docs_anova <- function() {
  ...
  normal_dbc <- normal_p("sem modelo que sirva, o `models/friedman` (uma observação por bloco e tratamento; com blocos incompletos ele usa o Durbin ou o Skillings–Mack).")
