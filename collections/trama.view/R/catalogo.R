...
`data/filter` para olhar de perto uma região da nuvem.", .TR_VIEW_AJUDA_APARENCIA)),
    ...
    trama::tr_node("view/heatmap", fn = tr_heatmap, label = "Mapa de calor",
      ...
      inputs = list(dados = T), outputs = list(out = G),
      params = .tr_view_props(
        x = trama::tr_param_col("", label = "Colunas", role = "qualquer", example = "mes"),
        y = trama::tr_param_col("", label = "Linhas", role = "qualquer", example = "regiao"),
        valor = trama::tr_param_col("", label = "Valor", role = "numerica", example = "receita"),
...
`data/group_summarise` quando o valor não é soma nem contagem.", .TR_VIEW_AJUDA_APARENCIA)),
    ...
    trama::tr_node("view/dumbbell", fn = tr_dumbbell, label = "Halteres",
      ...
      params = .tr_view_props(
        ...
        cor = trama::tr_param_col("", label = "Condição", role = "categorica", example = "ano"),
        y = trama::tr_param_col("", label = "Valor", role = "numerica", example = "receita"),
...
uma medida por unidade e condição.", .TR_VIEW_AJUDA_APARENCIA)),
    ...
    trama::tr_node("view/pareto", fn = tr_pareto, label = "Pareto",
      ...
      inputs = list(dados = T), outputs = list(out = G),
      params = .tr_view_props(
        x = trama::tr_param_col("", label = "Categoria", role = "categorica", example = "defeito"),
        y = trama::tr_param_col("", label = "Valor", role = "numerica", example = "custo"),
